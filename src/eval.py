...
class OverrideConfig(FairseqDataclass):
    ...
    prompt_path: str = field(default='None', metadata={'help': 'path to llama checkpoint'})
...
def _main(cfg, output_file):
    ...
    model_override_cfg = {'model':{'llm_ckpt_path':cfg.override.llm_ckpt_path,'prompt_path':cfg.override.prompt_path}}
    ...
    #task.load_dataset('valid', task_cfg=cfg.task)
