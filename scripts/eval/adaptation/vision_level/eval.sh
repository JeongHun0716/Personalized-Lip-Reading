...
do
    MODEL_PATH=$SRC_PTH/pretrained_models/adapted_model/vision/voxlrs-$i/checkpoints/checkpoint_best.pt
    OUT_PATH=$SRC_PTH/results/adaptation/vision/voxlrs-$i   # output path to save
