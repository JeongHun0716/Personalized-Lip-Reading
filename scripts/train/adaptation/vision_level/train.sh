...
OUT_PATH=$SRC_PTH/exp/adaptation/vision/voxlrs-$i

PYTHONPATH=$ROOT/fairseq \
CUDA_VISIBLE_DEVICES=0 fairseq-hydra-train --config-dir ${SRC_PTH}/conf/adaptation --config-name vision.yaml \
